...
public class SFXPlayer : MonoBehaviour
{
    ...
    public static SFXPlayer Instance
    {
        get
        {
            if (instance == null)
            {
                var sceneResult = FindObjectOfType<SFXPlayer>();
    ...
    void OnAwake()
    {
        GambaFunctions.ResizeList<SFXClip, SFXTag>(ref sfxClips);
        GambaFunctions.ResizeList<SFXLoopClip, SFXLoopTag>(ref sfxLoopClips);
    ...
    {
        SFXTag tag = randomTags[UnityEngine.Random.Range(0, randomTags.Length)];
